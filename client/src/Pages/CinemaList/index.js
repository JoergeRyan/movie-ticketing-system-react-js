        ...
        <div id="cinemaListBody" >
            ...
            <div id="cinemaListContainer">
                <div id="buttonContainer">
                    <button id="buttonCList" onClick={() =>onClickCinema(0)}>Cinema 1</button>
                    <button id="buttonCList" onClick={() =>onClickCinema(1)}>Cinema 2</button>
                    <button id="buttonCList" onClick={() =>onClickCinema(2)}>Cinema 3</button>
                    <button id="buttonCList" onClick={() =>onClickCinema(3)}>Cinema 4</button>
                    <button id="buttonCList" onClick={() =>onClickCinema(4)}>Cinema 5</button>
                </div>
                        ...
                        <div id="movieDescriptionContainer">
                            <div id="cinemaDescription">
                                <p > Line 2:22:   'Form' is defined but never used                                                                           no-unused-vars
                                    Line 4:12:   'Data4:12:   'DataHandler' is defined but never used                                                                    no-unused-vars
                                    Line 4:27:   'dataHandler' is defined but never used                                                                    no-unused-vars
                                    Line 23:25:  img 4:12:   'DataH4:12:   'DataHandler' is defined but never used                                                                    no-unused-vars
                                    Line 4:12:   'Data4:12:   'DataHandler' is defined but never used                                                                    no-unused-vars
                                    Line 4:27:   'dataHandler' is defined but never used                                                                    no-unused-vars
                                    Line 23:25:  img 4
                                    Line 23:25:  img 4:12:   'DataH4:12:   'DataHandler' is defined but never used                                                                    no-unused-vars
